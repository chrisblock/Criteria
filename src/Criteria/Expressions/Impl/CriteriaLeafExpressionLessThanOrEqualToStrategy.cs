...
{
	public class CriteriaLeafExpressionLessThanOrEqualToStrategy : ICriteriaLeafExpressionStrategy
	{
		...
		public Expression GetExpression(ICriteriaLeaf leaf)
		{
			...
			return Expression.LessThanOrEqual(accessorExpression, Expression.Constant(typedValue, type.PropertyType));
		}
	}
}
