...
{
	class CriteriaLeafExpressionDoesNotContainStrategy : ICriteriaLeafExpressionStrategy
	{
		private readonly ICriteriaTypeRegistry _typeRegistry;

		public CriteriaLeafExpressionDoesNotContainStrategy(ICriteriaTypeRegistry typeRegistry)
		{
		...
		public Expression GetExpression(ICriteriaLeaf leaf)
		{
			...
			return Expression.Not(Expression.Call(accessorExpression, "Contains", Type.EmptyTypes, new Expression[] { Expression.Constant(typedValue, type.PropertyType) }));
		}
	}
}
